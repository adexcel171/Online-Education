                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        ...
                        <div class="dropdown-menu">
                            <Link class="dropdown-item" to='/'>Courses 1</Link>
                            <Link class="dropdown-item" to='/'>Courses 2</Link>
                            <Link class="dropdown-item" to='/'>Courses 3</Link>
                        </div>
                    </div>
                        ...
                        <div class="form-row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="text" class="form-control bg-light border-0" placeholder="Your Name" px-3  py-2/>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="email" class="form-control bg-light border-0" placeholder="Your Email" py-2 px-1 />
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
