    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom mb-2">
        <div class="container text-center py-5">
            ...
            <div class="d-inline-flex text-white mb-5">
                <p class="m-0 text-uppercase"><Link class="text-white" to='/home'>Home</Link></p>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        ...
                        <div class="dropdown-menu">
                            <Link class="dropdown-item" to='/details'>Courses 1</Link>
                            <Link class="dropdown-item" to='/details'>Courses 2</Link>
                            <Link class="dropdown-item" to='/details'>Courses 3</Link>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <img class="img-fluid rounded w-100 mb-4" src="img/header.jpg" alt=""/>
                    ...
                    <div class="owl-carousel related-carousel position-relative p-2" >
                        <Link class="courses-list-item position-relative d-block overflow-hidden mb-2" to='/details'>
